...
PTS_SPACE = 1   # number of pixel skipped between two spatial point
...
def capture(fileName):
    ...
    try:
        ...
        for _ in range(PRE_FRAME):
            pipeline.wait_for_frames()
        
        # Create a capture
        frame = capture_one_frame(pipeline, metadata, fileName)
    finally:
